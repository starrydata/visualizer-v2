...
def simple_graph():
    ...
    data_points = XYPoints(data=[XYPoint(1, 4, "2024-01-01T00:00:00Z"), XYPoint(2, 5, "2024-01-01T00:00:00Z"), XYPoint(3, 6, "2024-01-01T00:00:00Z")])
    data_point_series = XYSeries(data=[XYPoints(data=data_points.data)])
    return Graph(x_axis=x_axis, y_axis=y_axis, data=data_point_series.data)
